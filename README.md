...
## ÖDEVLER
  ...
  - [Final Ödev 1](https://github.com/denizcantufekci/Programming_Lab/blob/master/Odev/180401060_Final_Q1.py): Matris üzerinde çeşitli manipülsyonlar yapıldı. (Belirli yönlerde belirli kelimeler eklendi. Palindrom kelime analizi yapıldı.) Ve bu işlemler otomatize edilip çeşitli testlere sokularak elde edilen sonuçlar kullanıcı ile paylaşıldı.
  - [Final Ödev 2](https://github.com/denizcantufekci/Programming_Lab/blob/master/Odev/180401060_Final_Q2.py): Rastgele belirlenen vektörlerden matrisler oluşturuldu. Sonrasında oluşturulan farklı matrislerin birbirleri arasında çarpımları sağlandı. Ve bu işlemler otomatize edilip çeşitli testlere sokularak elde edilen sonuçlar kullanıcı ile paylaşıldı.
## QUİZLER
